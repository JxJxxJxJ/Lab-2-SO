...
/*
    DESCRIPCION: Busca el primer semáforo inactivo en el arreglo de semáforos `sem_array`.
    ...
    POSTCONDICION: Si i = sem_find_free_channel_and_set(value) entonces
                      Si habia un canal libre    => i     = numero del semaforo libre 
